...
import { FlaskConical, Github, Image as ImageIcon } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((item, i) => (
            <motion.div
              ...
              className="glass rounded-xl overflow-hidden hover:glow-border transition-all duration-300 cursor-pointer"
