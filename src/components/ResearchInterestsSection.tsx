...
import { Lightbulb, Brain, Eye, Cpu, Globe, Wifi, Sparkles } from 'lucide-react';
      ...
      <div className="section-container">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-display font-bold mb-4 flex items-center gap-3">
            ...
            <span>Research <span className="text-gradient-primary">Interests</span></span>
          </h2>
          ...
          <p className="text-muted-foreground max-w-3xl text-sm sm:text-base leading-relaxed">
            My research is driven by a passion for building intelligent systems that solve real-world problems. 
            I work at the intersection of AI, machine learning, NLP, and computer vision — with a strong emphasis 
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {interests.map((item, i) => (
            ...
            >
              ...
              <h3 className="font-display font-semibold text-foreground text-base mb-3">{item.title}</h3>
